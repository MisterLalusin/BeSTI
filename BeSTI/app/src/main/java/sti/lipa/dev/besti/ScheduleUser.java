...
public class ScheduleUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scheduleuser);
    ...
    private void populateListView() {
        ...
        Cursor data = db.rawQuery("SELECT *FROM tblscheduser WHERE Day=? AND StudentNumber=?",new String[]{weekday_name,number});
